...
function NewArrivals() {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                const response = await axios.get(`${urls}/product/tags/newarrival`);
    ...
    return (
        <div>
            <h1 className='font-semibold text-4xl text-center mt-5'>New Arrivals</h1>
            <div
                    ...
                    >
                        ...
                        <div className="relative bottom-2 left-0 right-0 flex items-center gap-5 mt-5 w-full  flex flex-col sm:flex-row items-center  gap-5 w-full px-2">
                            <button
                                ...
                                onClick={() => navigate(`/display/${category._id}/${category.variantId}`)}
                            >
                                Order Now
                            </button>
